...
class Game(object):
    ...
    def __init__(self,
        ...
        self.bricks = []
        brick_x = self.width - (wall_width + 2*brick_height)
        for i in range(6):
            brick_y = self.height - (wall_width + brick_height)
            for i in range(int(self.height/brick_height)):
                self.bricks.append(Brick(initial_x = brick_x, initial_y = brick_y, img_file = wall_imgs[2], game = self))
